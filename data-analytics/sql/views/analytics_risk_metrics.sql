-- PUL-312: Risk metrics analytics view.
...
classified_participants as (
    ...
    select
        ...
        case
            -- Completed screening activity exists,
            -- but there is no Completed screening containing
            -- a supported PUL-312 risk measurement.
...
risk_categories as (
    -- Always expose all four risk categories.
...
organisations_with_screenings as (
    -- Organisations represented in the analytics population.
    select distinct
        organisation_id
...
organisation_categories as (
    ...
    -- including categories with zero participants.
    select
