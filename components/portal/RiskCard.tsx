  ...
  return (
    <>
      <button
        ...
        className="w-full cursor-pointer rounded-lg border border-card-border bg-soft-bg p-4 text-left transition hover:-translate-y-0.5 hover:bg-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/15"
      >
