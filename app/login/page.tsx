...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex h-[100dvh] max-h-[100dvh] items-center justify-center overflow-hidden bg-[#f7f8fa] px-4 py-3 text-navy sm:px-8 sm:py-6">
        ...
        <section className="rounded-[20px] border border-[#dfe3e8] bg-white p-4 shadow-[0_18px_48px_rgba(20,43,83,0.08)] sm:rounded-[24px] sm:p-7">
          ...
          <form className="mt-5 space-y-3.5 sm:mt-6 sm:space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="group flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-navy px-4 text-[13px] font-semibold !text-white transition hover:-translate-y-0.5 hover:bg-pulse-red active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60"
            >
